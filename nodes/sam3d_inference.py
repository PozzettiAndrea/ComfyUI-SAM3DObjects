...
#
# This file is adapted from sam-3d-objects/notebook/inference.py
# for use in ComfyUI-SAM3DObjects custom node.
# Original: https://github.com/facebookresearch/sam-3d-objects
#

import os
import sys

# Set environment variables if running in conda environment
# This is conditional to support non-conda environments
...
# Import from vendored sam3d_objects package
import sys
from pathlib import Path

# Add vendor directory to path so sam3d_objects can import itself correctly
